...
import { ShieldCheck, User, Lock, ArrowRight, ArrowLeft, Loader } from 'lucide-react';
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (res.data.user.role === 'RECEPTIONIST' || res.data.user.role === 'ADMIN') {
          navigate('/reception/dashboard');
        } else {
          setError('Unauthorized: This portal is for Reception staff only.');
        }
      }
    } catch (err) {
