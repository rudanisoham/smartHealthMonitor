...
const LabLayout = () => {
  ...
  return (
    <div className={`admin-app ${sidebarCollapsed ? 'sidebar-collapsed' : ''} ${mobileSidebarOpen ? 'mobile-sidebar-open' : ''}`}>
      ...
      <LabSidebar collapsed={sidebarCollapsed} />
      ...
      <main className="admin-main">
        <header className="admin-header">
          <div className="header-left">
            ...
            <h1 className="page-title">Laboratory Console <span>Diagnostic Management</span></h1>
          </div>
        ...
        <footer className="admin-footer">
          <p>&copy; 2026 Smart Health Monitor System • <strong>Laboratory Services</strong></p>
        </footer>
      </main>
    </div>
  );
